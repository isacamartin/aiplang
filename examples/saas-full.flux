# Full SaaS — home + dashboard + login
# flux-web v1.0
...
hero{Ship faster with AI|Deploy in seconds. Zero config.>/dashboard:Open app>/pricing:See plans}
stats{@stats.users:Users|@stats.mrr:MRR|@stats.uptime:Uptime}
row3{rocket>Deploy instantly>Push to git, live in 3 seconds.|shield>Enterprise>SOC2, GDPR, SSO built-in.|chart>Observability>Real-time errors and performance.}
...
nav{AppName>/users:Users>/logout:Sign out}
