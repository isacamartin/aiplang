...
FLUX v2 is a complete web language. One `.flux` file replaces:
- Next.js (frontend)
...
```bash
# Install
go install github.com/isacamartin/flux2/cmd/fluxd@latest

# Run
DATABASE_URL=sqlite://./app.db JWT_SECRET=secret fluxd dev myapp.flux
